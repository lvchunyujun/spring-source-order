 ...
 */
public class RedisSentinelUtil<T extends Serializable> {

    private static JedisSentinelPool jedisReader =(JedisSentinelPool) SpringContextUtil.getBean("jedisSentinelPool");
    private static JedisSentinelPool jedisWriter =(JedisSentinelPool) SpringContextUtil.getBean("jedisSentinelPool");

    private static class LazyHolder {
        private static final RedisSentinelUtil INSTANCE = new RedisSentinelUtil();
    }

    private static final String tagName = "redis:";
    private static final int outTime = 5184000;

    private RedisSentinelUtil() {
    }

    public static final RedisSentinelUtil getInstance() {
    ...
    public long setNx(String key, String value){
        ...
        try {
            key = tagName + key;
            writer = jedisWriter.getResource();
            long result = writer.setnx(key, value);
            return result;
        } catch (Exception ex) {
            ex.printStackTrace();
            return -1;
